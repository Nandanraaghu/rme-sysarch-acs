...
function (create_executable EXE_NAME OUTPUT_DIR TEST)
    ...
    add_custom_command(OUTPUT CPP-LD--${EXE_NAME}${TEST}
                    COMMAND ${CROSS_COMPILE}gcc -E -P -I${ROOT_DIR}/baremetal_app/ -I${ROOT_DIR}/platform/pal_baremetal/${TARGET}/include -I${ROOT_DIR} ${SCATTER_INPUT_FILE} -o ${SCATTER_OUTPUT_FILE} -DCMAKE_BUILD={CMAKE_BUILD}
